...
const VehicleTypeService_1 = __importDefault(require("../services/VehicleTypeService"));
...
let VehicleTypeController = class VehicleTypeController {
    ...
    async createVehicleType(req, res, next) {
        ...
        try {
            ...
            const callService = await this.vehicleTypeServiceInstance.createVehicleType(req.body);
